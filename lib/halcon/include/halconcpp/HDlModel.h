...
public:
  ...
  HDlModel& operator=(const HDlModel&) = default;
#endif
 ...
 *****************************************************************************/
  ...
  // Infer the sample and generate a heatmap.
  HDict GenDlModelHeatmap(const HDict& DLSample, const HString& HeatmapMethod, const HTuple& TargetClasses, const HDict& GenParam) const;

  // Infer the sample and generate a heatmap.
  HDict GenDlModelHeatmap(const HDict& DLSample, const char* HeatmapMethod, const HTuple& TargetClasses, const HDict& GenParam) const;

#ifdef _WIN32
  // Infer the sample and generate a heatmap.
  HDict GenDlModelHeatmap(const HDict& DLSample, const wchar_t* HeatmapMethod, const HTuple& TargetClasses, const HDict& GenParam) const;
#endif
