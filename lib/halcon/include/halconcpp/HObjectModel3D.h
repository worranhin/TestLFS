...
public:
  ...
  HObjectModel3D& operator=(const HObjectModel3D&) = default;
#endif
...
/*****************************************************************************
 * Convenience members for HObjectModel3D
 * (avoid compatibility break after changes in read_object_model_3d, HA-38637)
 *****************************************************************************/

// Provide constructor as in HA 24.05. GenParam split_level is not supported.
...
// Provide function as in HA 24.05. GenParam split_level is not supported.
HTuple ReadObjectModel3d(const HString& FileName, const HTuple& Scale, const HTuple& GenParamName, const HTuple& GenParamValue);
  ...
  static HObjectModel3DArray SampleObjectModel3d(const HObjectModel3DArray& ObjectModel3D, const HString& Method, const HTuple& SamplingParam, const HTuple& GenParamName, const HTuple& GenParamValue);

  // Sample a 3D object model.
  HObjectModel3D SampleObjectModel3d(const HString& Method, double SamplingParam, const HTuple& GenParamName, const HTuple& GenParamValue) const;

  // Sample a 3D object model.
  HObjectModel3D SampleObjectModel3d(const char* Method, double SamplingParam, const HTuple& GenParamName, const HTuple& GenParamValue) const;

#ifdef _WIN32
  // Sample a 3D object model.
  HObjectModel3D SampleObjectModel3d(const wchar_t* Method, double SamplingParam, const HTuple& GenParamName, const HTuple& GenParamValue) const;
#endif
  ...
  static HTuple ReadObjectModel3d(const HString& FileName, const HTuple& Scale, const HTuple& GenParamName, const HTuple& GenParamValue, HObjectModel3DArray* ObjectModel3D);
  ...
  void ReconstructSurfaceStructuredLight(const HStructuredLightModel& StructuredLightModel);
