...
public:
  ...
  HXLDCont& operator=(const HXLDCont&) = default;
#endif
 ...
 *****************************************************************************/
  ...
  HTuple DistanceCcMin(const HXLDCont& Contour2, const HTuple& Mode) const;

  // Calculate the minimum distance between two contours.
  double DistanceCcMin(const HXLDCont& Contour2, const HString& Mode) const;

  // Calculate the minimum distance between two contours.
  double DistanceCcMin(const HXLDCont& Contour2, const char* Mode) const;

#ifdef _WIN32
  // Calculate the minimum distance between two contours.
  double DistanceCcMin(const HXLDCont& Contour2, const wchar_t* Mode) const;
#endif

  // Calculate the distance between two contours.
  void DistanceCc(const HXLDCont& Contour2, const HTuple& Mode, HTuple* DistanceMin, HTuple* DistanceMax) const;
  ...
  HTuple DistanceCcMinPoints(const HXLDCont& Contour2, const HTuple& Mode, HTuple* Row1, HTuple* Column1, HTuple* Row2, HTuple* Column2) const;
  ...
  HXLDCont IntersectionRegionContourXld(const HRegion& Region, const HString& Mode) const;

  // Intersect a contour with a region.
  HXLDCont IntersectionRegionContourXld(const HRegion& Region, const char* Mode) const;

#ifdef _WIN32
  // Intersect a contour with a region.
  HXLDCont IntersectionRegionContourXld(const HRegion& Region, const wchar_t* Mode) const;
#endif
