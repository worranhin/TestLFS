...
public:
  ...
  HRegion& operator=(const HRegion&) = default;
#endif
...
HTuple Column() const;
  ...
  HXLDCont IntersectionRegionContourXld(const HXLDCont& Contour, const HString& Mode) const;

  // Intersect a contour with a region.
  HXLDCont IntersectionRegionContourXld(const HXLDCont& Contour, const char* Mode) const;

#ifdef _WIN32
  // Intersect a contour with a region.
  HXLDCont IntersectionRegionContourXld(const HXLDCont& Contour, const wchar_t* Mode) const;
#endif

  // Test if points are contained in regions.
  HTuple TestRegionPoints(const HTuple& Row, const HTuple& Column) const;

  // Test if points are contained in regions.
  Hlong TestRegionPoints(Hlong Row, Hlong Column) const;
