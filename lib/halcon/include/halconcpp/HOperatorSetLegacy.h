...
LIntExport Herror sample_object_model_3d(const HTuple& ObjectModel3D, const HTuple& Method, const HTuple& SamplingParam, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SampledObjectModel3D);
...
LIntExport Herror gray_histo_range(const HObject& Region, const HObject& Image, const HTuple& Min, const HTuple& Max, const HTuple& NumBins, HTuple* Histo, HTuple* BinSize);

LIntExport Herror histo_2dim(const HObject& Regions, const HObject& ImageCol, const HObject& ImageRow, HObject* Histo2Dim);

LIntExport Herror gray_histo_abs(const HObject& Region, const HObject& Image, const HTuple& Quantization, HTuple* AbsoluteHisto);

LIntExport Herror gray_histo(const HObject& Region, const HObject& Image, HTuple* AbsoluteHisto, HTuple* RelativeHisto);
...
LIntExport Herror compare_memory_block(const HTuple& MemoryBlocks1, const HTuple& MemoryBlocks2, HTuple* IsEqual);

LIntExport Herror create_dl_layer_depth_to_space(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& BlockSize, const HTuple& Mode, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerDepthToSpace);

LIntExport Herror create_dl_layer_identity(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerIdentity);

LIntExport Herror create_memory_block_extern(const HTuple& Pointer, const HTuple& Size, const HTuple& FreeFunction, HTuple* MemoryBlockHandle);

LIntExport Herror create_memory_block_extern_copy(const HTuple& Pointer, const HTuple& Size, HTuple* MemoryBlockHandle);

LIntExport Herror decrypt_serialized_item(const HTuple& EncryptedItemHandle, const HTuple& DecryptionParam, HTuple* SerializedItemHandle);

LIntExport Herror encrypt_serialized_item(const HTuple& SerializedItemHandle, const HTuple& EncryptionParam, HTuple* EncryptedItemHandle);

LIntExport Herror get_memory_block_ptr(const HTuple& MemoryBlockHandle, HTuple* Pointer, HTuple* Size);

LIntExport Herror image_to_memory_block(const HObject& Image, const HTuple& Format, const HTuple& FillColor, HTuple* MemoryBlockHandle);

LIntExport Herror memory_block_to_image(HObject* Image, const HTuple& MemoryBlockHandle);

LIntExport Herror read_encrypted_item(const HTuple& FileName, HTuple* EncryptedItemHandle);

LIntExport Herror read_memory_block(const HTuple& FileName, HTuple* MemoryBlockHandle);

LIntExport Herror tuple_constant(const HTuple& Name, HTuple* Value);

LIntExport Herror tuple_is_nan_elem(const HTuple& T, HTuple* IsNaN);

LIntExport Herror write_encrypted_item(const HTuple& EncryptedItemHandle, const HTuple& FileName);

LIntExport Herror write_memory_block(const HTuple& MemoryBlockHandle, const HTuple& FileName);

LIntExport Herror add_image_border(const HObject& Image, HObject* ImageBorder, const HTuple& Size, const HTuple& Value);

LIntExport Herror apply_deep_counting_model(const HObject& Image, const HTuple& DeepCountingHandle, HTuple* Count, HTuple* DeepCountingResult);

LIntExport Herror create_deep_counting_model(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DeepCountingHandle);

LIntExport Herror create_dl_layer_matmul(const HTuple& DLLayerA, const HTuple& DLLayerB, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerMatMul);

LIntExport Herror get_deep_counting_model_param(const HTuple& DeepCountingHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror prepare_deep_counting_model(const HObject& Templates, const HTuple& DeepCountingHandle);

LIntExport Herror read_deep_counting_model(const HTuple& FileName, HTuple* DeepCountingHandle);

LIntExport Herror set_deep_counting_model_param(const HTuple& DeepCountingHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror write_deep_counting_model(const HTuple& DeepCountingHandle, const HTuple& FileName);

LIntExport Herror create_dl_layer_reduce(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Operation, const HTuple& Axes, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerReduce);

LIntExport Herror reconstruct_surface_structured_light(const HTuple& StructuredLightModel, HTuple* ObjectModel3D);

LIntExport Herror intersection_region_contour_xld(const HObject& Region, const HObject& Contour, HObject* ContourIntersection, const HTuple& Mode);

LIntExport Herror tuple_repeat(const HTuple& Tuple, const HTuple& Num, HTuple* Result);

LIntExport Herror tuple_repeat_elem(const HTuple& Tuple, const HTuple& Num, HTuple* Result);

LIntExport Herror tuple_str_replace(const HTuple& String, const HTuple& Before, const HTuple& After, HTuple* Replaced);

LIntExport Herror apply_deep_matching_3d(const HObject& Images, const HTuple& Deep3DMatchingModel, HTuple* DeepMatchingResults);

LIntExport Herror fit_dl_out_of_distribution(const HTuple& DLModelHandle, const HTuple& DLDataset, const HTuple& GenParam);

LIntExport Herror get_deep_matching_3d_param(const HTuple& Deep3DMatchingModel, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror read_deep_matching_3d(const HTuple& FileName, HTuple* Deep3DMatchingModel);

LIntExport Herror set_deep_matching_3d_param(const HTuple& Deep3DMatchingModel, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror test_region_points(const HObject& Regions, const HTuple& Row, const HTuple& Column, HTuple* IsInside);

LIntExport Herror tuple_str_distance(const HTuple& String1, const HTuple& String2, const HTuple& Mode, HTuple* Distance);

LIntExport Herror write_deep_matching_3d(const HTuple& Deep3DMatchingModel, const HTuple& FileName);
