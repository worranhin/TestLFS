...
HXAllocDomainImageTmp(Hproc_handle proc_handle, void* mem_ptr, void* img_ptr,
                      Hrlregion const* region, HIMGDIM width, HIMGDIM height,
                      int bytes_per_pixel, HIMGDIM border_rows,
