...
LIntExport Herror T_sample_object_model_3d(const Htuple ObjectModel3D, const Htuple Method, const Htuple SamplingParam, const Htuple GenParamName, const Htuple GenParamValue, Htuple *SampledObjectModel3D);
...
LIntExport Herror T_gray_histo_range(const Hobject Region, const Hobject Image, const Htuple Min, const Htuple Max, const Htuple NumBins, Htuple *Histo, Htuple *BinSize);
LIntExport Herror gray_histo_range(const Hobject Region, const Hobject Image, double Min, double Max, Hlong NumBins, Hlong *Histo, double *BinSize);
...
LIntExport Herror T_gray_histo_abs(const Hobject Region, const Hobject Image, const Htuple Quantization, Htuple *AbsoluteHisto);
LIntExport Herror T_gray_histo(const Hobject Region, const Hobject Image, Htuple *AbsoluteHisto, Htuple *RelativeHisto);
...
LIntExport Herror T_compare_memory_block(const Htuple MemoryBlocks1, const Htuple MemoryBlocks2, Htuple *IsEqual);
LIntExport Herror T_create_dl_layer_depth_to_space(const Htuple DLLayerInput, const Htuple LayerName, const Htuple BlockSize, const Htuple Mode, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerDepthToSpace);
LIntExport Herror T_create_dl_layer_identity(const Htuple DLLayerInput, const Htuple LayerName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerIdentity);
LIntExport Herror T_create_memory_block_extern(const Htuple Pointer, const Htuple Size, const Htuple FreeFunction, Htuple *MemoryBlockHandle);
LIntExport Herror T_create_memory_block_extern_copy(const Htuple Pointer, const Htuple Size, Htuple *MemoryBlockHandle);
LIntExport Herror T_decrypt_serialized_item(const Htuple EncryptedItemHandle, const Htuple DecryptionParam, Htuple *SerializedItemHandle);
LIntExport Herror T_encrypt_serialized_item(const Htuple SerializedItemHandle, const Htuple EncryptionParam, Htuple *EncryptedItemHandle);
LIntExport Herror T_get_memory_block_ptr(const Htuple MemoryBlockHandle, Htuple *Pointer, Htuple *Size);
LIntExport Herror T_image_to_memory_block(const Hobject Image, const Htuple Format, const Htuple FillColor, Htuple *MemoryBlockHandle);
LIntExport Herror T_memory_block_to_image(Hobject *Image, const Htuple MemoryBlockHandle);
LIntExport Herror T_read_encrypted_item(const Htuple FileName, Htuple *EncryptedItemHandle);
LIntExport Herror T_read_memory_block(const Htuple FileName, Htuple *MemoryBlockHandle);
LIntExport Herror T_tuple_constant(const Htuple Name, Htuple *Value);
LIntExport Herror tuple_constant(const char *Name, Hlong *Value);
LIntExport Herror T_tuple_is_nan_elem(const Htuple T, Htuple *IsNaN);
LIntExport Herror tuple_is_nan_elem(double T, Hlong *IsNaN);
LIntExport Herror T_write_encrypted_item(const Htuple EncryptedItemHandle, const Htuple FileName);
LIntExport Herror T_write_memory_block(const Htuple MemoryBlockHandle, const Htuple FileName);
LIntExport Herror T_add_image_border(const Hobject Image, Hobject *ImageBorder, const Htuple Size, const Htuple Value);
LIntExport Herror add_image_border(const Hobject Image, Hobject *ImageBorder, Hlong Size, Hlong Value);
LIntExport Herror T_apply_deep_counting_model(const Hobject Image, const Htuple DeepCountingHandle, Htuple *Count, Htuple *DeepCountingResult);
LIntExport Herror T_create_deep_counting_model(const Htuple GenParamName, const Htuple GenParamValue, Htuple *DeepCountingHandle);
LIntExport Herror T_create_dl_layer_matmul(const Htuple DLLayerA, const Htuple DLLayerB, const Htuple LayerName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerMatMul);
LIntExport Herror T_get_deep_counting_model_param(const Htuple DeepCountingHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_prepare_deep_counting_model(const Hobject Templates, const Htuple DeepCountingHandle);
LIntExport Herror T_read_deep_counting_model(const Htuple FileName, Htuple *DeepCountingHandle);
LIntExport Herror T_set_deep_counting_model_param(const Htuple DeepCountingHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_write_deep_counting_model(const Htuple DeepCountingHandle, const Htuple FileName);
LIntExport Herror T_create_dl_layer_reduce(const Htuple DLLayerInput, const Htuple LayerName, const Htuple Operation, const Htuple Axes, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerReduce);
LIntExport Herror T_reconstruct_surface_structured_light(const Htuple StructuredLightModel, Htuple *ObjectModel3D);
LIntExport Herror T_intersection_region_contour_xld(const Hobject Region, const Hobject Contour, Hobject *ContourIntersection, const Htuple Mode);
LIntExport Herror intersection_region_contour_xld(const Hobject Region, const Hobject Contour, Hobject *ContourIntersection, const char *Mode);
LIntExport Herror T_tuple_repeat(const Htuple Tuple, const Htuple Num, Htuple *Result);
LIntExport Herror tuple_repeat(Hlong Tuple, Hlong Num, Hlong *Result);
LIntExport Herror T_tuple_repeat_elem(const Htuple Tuple, const Htuple Num, Htuple *Result);
LIntExport Herror tuple_repeat_elem(Hlong Tuple, Hlong Num, Hlong *Result);
LIntExport Herror T_tuple_str_replace(const Htuple String, const Htuple Before, const Htuple After, Htuple *Replaced);
LIntExport Herror tuple_str_replace(const char *String, const char *Before, const char *After, char *Replaced);
LIntExport Herror T_apply_deep_matching_3d(const Hobject Images, const Htuple Deep3DMatchingModel, Htuple *DeepMatchingResults);
LIntExport Herror T_fit_dl_out_of_distribution(const Htuple DLModelHandle, const Htuple DLDataset, const Htuple GenParam);
LIntExport Herror T_get_deep_matching_3d_param(const Htuple Deep3DMatchingModel, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_read_deep_matching_3d(const Htuple FileName, Htuple *Deep3DMatchingModel);
LIntExport Herror T_set_deep_matching_3d_param(const Htuple Deep3DMatchingModel, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_test_region_points(const Hobject Regions, const Htuple Row, const Htuple Column, Htuple *IsInside);
LIntExport Herror test_region_points(const Hobject Regions, Hlong Row, Hlong Column, Hlong *IsInside);
LIntExport Herror T_tuple_str_distance(const Htuple String1, const Htuple String2, const Htuple Mode, Htuple *Distance);
LIntExport Herror tuple_str_distance(const char *String1, const char *String2, const char *Mode, Hlong *Distance);
LIntExport Herror T_write_deep_matching_3d(const Htuple Deep3DMatchingModel, const Htuple FileName);
