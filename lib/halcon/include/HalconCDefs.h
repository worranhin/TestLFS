...
#  define _t (Htuple*)0 /* anonymous variable (tuple)     */
#endif
 ...
 * the parameters are set before calling T_call_halcon with set_*_[t|o]par
 ...
 *---------------------------------------------------------------------------*/
LIntExport Herror T_test_equal_dict_item(const Htuple dicts, const Htuple key1,
                                         const Htuple key2, Htuple* result);
