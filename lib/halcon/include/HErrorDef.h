...
#define H_ERR_LIC_MAXSESSIONS         2028 /* Session limit exceeded */
...
#define H_ERR_LIC_NOSERVRESP          2069 /* Server did not respond to
                                              message */
#define H_ERR_LIC_SETSOCKFAIL         2075 /* setsockopt() failed */
#define H_ERR_LIC_BADCHECKSUM         2076 /* Message checksum failure */
#define H_ERR_LIC_INTERNAL_ERROR      2082 /* Internal licensing error */
...
#define H_ERR_LIC_INVALID_CERTIFICATE 2321 /* Invalid license server
                                              certificate */
#define H_ERR_LIC_INVALID_TLS_CERTIFICATE 2335 /* Invalid license server
                                           SSL/TLS certificate */
...
/*
 * Due to historical reasons, license error codes occupy two different ranges
 * of error codes. Make sure to adapt the following definitions if you add or
 * remove licensing error codes.
 */
#define H_ERR_LIC_RANGE1_BEGIN      H_ERR_LIC_NO_LICENSE
#define H_ERR_LIC_RANGE1_END        H_ERR_LIC_POOL
#define H_ERR_LIC_RANGE2_BEGIN      H_ERR_LIC_NODONGLE
#define H_ERR_LIC_RANGE2_END        H_ERR_LIC_NEWVER
...
#define H_ERR_HANDLE_CYCLES  2456 /* Reference cycles of handles found */
...
#define H_ERR_SLM_NOT_DECODED    3960 /* The SLM is not decoded for deflectometry. */
#define H_ERR_SLM_WRONGMODEL     3961 /* Wrong model type*/
#define H_ERR_SLM_WNUMCAMS       3962 /* The csm has to contain two camera parameters */
#define H_ERR_SLM_WPATTSIZE      3963 /* Inconsistent projector size */
#define H_ERR_SLM_WRONGCTYPE     3964 /* Camera type not supported */
#define H_ERR_SLM_WRONGPTYPE     3965 /* Projector type not supported */
#define H_ERR_SLM_NO_CSM         3966 /* The SLM does not contain a csm */
#define H_ERR_SLM_NO_VERT        3967 /* The SLM is not set for vertical decoding */
#define H_ERR_SLM_NOT_DEC_REC    3968 /* The SLM is not decoded for reconstruction */
#define H_ERR_SLM_WCAMSIZE       3969 /* Inconsistent camera size */

/* Data Base and Image data management */
#define H_ERR_DBOIT        4050 /* Object is an object tuple */
#define H_ERR_DBOC         4051 /* Object has been deleted already */
#define H_ERR_DBWOID       4052 /* Wrong object-ID */
#define H_ERR_DBTC         4053 /* Object tuple has been deleted already */
#define H_ERR_DBWTID       4054 /* Wrong object tupel-ID */
#define H_ERR_DBTIO        4055 /* Object tuple is an object */
...
#define H_ERR_OPENCL_ERROR        4101 /* OpenCL Error occurred */
...
/* CUDA/cuDNN related error messages */
#define H_ERR_CUDA_ERROR                  4200 /* CUDA error occurred */
#define H_ERR_CUDNN_ERROR                 4201 /* cuDNN error occurred */
#define H_ERR_CUBLAS_ERROR                4202 /* cuBLAS error occurred */
...
#define H_ERR_DNNL_ERROR                  4303 /* Error occurred in DNNL library */

/* AI Acclerator Interface related error messages */
#define H_ERR_HAI2_ERROR                 4320 /* AI Accelerator Interface error occurred */
...
#define H_ERR_ACL_ERROR                   4400 /* ACL error occurred */
...
#define H_ERR_WRSPART      5174 /* negative height of area (or 0) */
#define H_ERR_WCSPART      5175 /* negative width of area (or 0) */
...
#define H_ERR_SOCKET_ILLEGAL_TUPLE_TYPE   5618 /* Unknown tuple type on
                                                  socket */
#define H_ERR_SOCKET_TIMEOUT              5619 /* Timeout occurred on socket */
...
#define H_ERR_TUPLE_DTLFTHV           5758 /* Number too big for a string to
                                              number conversion (overflow) */
...
#define H_ERR_IAD          6040 /* System parameter for memory-allocation
                                   inconsistent */
#define H_ERR_INVALID_ALIGN 6042 /* Invalid alignment */
...
#define H_ERR_TWC          7404 /* Tuple had been deleted; values are not
                                   valid any more */
/* CNNs */
...
#define H_ERR_DL_READ_ONNX 7801 /* Error occurred while reading an ONNX model */
#define H_ERR_DL_CLASS_IDS_MISSING 7802 /* DL: Model does not have class ids */
#define H_ERR_DL_WRITE_ONNX 7803 /* Error occurred while writing an ONNX model */
...
#define H_ERR_DL_GCAD_NETWORK_NOT_AVAILABLE 7870 /* DL: GC Anomaly Detection network not available */
...
#define H_ERR_DEEP_COUNTING_PREPARE_UNSUPPORTED 7942 /* Usage of prepare for a Deep Counting model is unsupported */
#define H_ERR_DEEP_COUNTING_NO_BACKBONE 7943 /* Deep Counting model does not contain a backbone */
...
#define H_ERR_SAME_XVAL_CONV  8376 /* Same x-value due to double to float
                                      conversion. */
...
#define H_ERR_CM_NOT_POSTPROCC  8452 /* auxiliary model results not available */
...
#define H_ERR_CAL_AMBIGUOUS                8495 /* Ambiguous calibration: Please,
...
#define H_ERR_BC_XCORR_NO_CORRELATION    8742 /* No correlation found during
                                                 barcode normalized cross
                                                 correlation */
#define H_ERR_INVALID_SYNTAX_DICTIONARY 8743 /* Invalid GS1 syntax dictionary */
...
#define H_ERR_BAR2D_SYMBOL_ON_BORDER 8807 /* Symbol region too near to image
                                             border */
#define H_ERR_BAR2D_MODULE_CONT_NUM  8808 /* No rectangular module boundings
                                             found */
...
#define H_ERR_BAR2D_DECODING_READER  8813 /* Reader programming not
                                             supported */
...
#define H_ERR_WPFO         9021 /* Wrong parameter for this operation */
...
#define H_ERR_NO_ENCRYPTED_ITEM 9800 /* Invalid file format for encrypted items */
#define H_ERR_WRONG_PASSWORD    9801 /* Wrong password */
#define H_ERR_ENCRYPT_FAILED    9802 /* Encryption failed */
#define H_ERR_DECRYPT_FAILED    9803 /* Decryption failed */
...
#define H_ERR_NO_MODULES              2005 /* No modules in license (no
                                              VENDOR_STRING) */
