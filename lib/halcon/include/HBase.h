...
#define DOUBLE_PAR 2     /* Parameter type: double                   */
...
#define ANY_ELEM (LONG_PAR | DOUBLE_PAR | STRING_PAR | HANDLE_PAR)
...
/*****************************************************************************/
/* This data structure contains all information about an instance of an     */
...
#  define H_FORCEINLINE __attribute__((always_inline)) H_INLINE
#else
